    ...
    <div class="container grid">
        <div class="page-member-login__wrapper col-5-9-medium">
            <div class="page-member-login__content">
                ...
                <form class="page-member-login__form">
                    <div class="page-member-login__form-input">
                        <label for="username">手機號碼/E-mail 信箱</label>
                        <input type="text" id="username" placeholder="請輸入...">
                    </div>
                    <div class="page-member-login__form-input">
                        <label for="password">密碼</label>
                        <div class="page-member-login__form-input-password">
                            <?php get_svg('lock') ?>
                            <input type="password" id="password" placeholder="請輸入您的密碼 ...">
                            <div class="page-member-login__form-input-password-show">
                                <?php get_svg('eye') ?>
                            </div>
                        </div>
                        <a href="">忘記密碼</a>
                    </div>
                    <div class="page-member-login__form-checkbox">
                        <input type="checkbox" id="remember">
                        <label for="remember">記住我</label>
                    </div>
                    <div class="page-member-login__form-btns">
                        <div class="page-member-login__form-btns-item">
                            <?php 
                                $tag="a";
                                $url="/member/register";
                                $text="註冊新帳戶";
                    ...
                    <div class="page-member-login__form-or">
                        <p>OR</p>
                    </div>
                    <h3>以其他方式登入</h3>
                    <div class="page-member-login__form-social">
                        <div class="page-member-login__form-social-btn -google">
                        ...
                        <div class="page-member-login__form-social-btn -facebook">
                            <?php get_svg('facebook') ?>
                            <p>Facebook 登入</p>
                        </div>
                        <div class="page-member-login__form-social-btn -line">
                            <?php get_svg('line') ?>
                            <p>LINE 登入</p>
                        </div>
                    </div>
