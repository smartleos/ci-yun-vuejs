...
<main class="page-member-register">
    <div class="container grid">
        <div class="page-member-register__wrapper col-5-9-medium">
            <div class="page-member-register__content">
                ...
                <form class="page-member-register__form">
                    <div class="page-member-register__form-input">
                        <label class="-require" for="name">您的大名</label>
                        <input type="text" id="name" placeholder="請輸入您的姓名...">
                    </div>
                    <div class="page-member-register__form-input">
                        <label class="-require" for="phone">聯絡電話</label>
                    ...
                    <div class="page-member-register__form-input">
                        <label class="-require" for="password">密碼</label>
                        <div class="page-member-register__form-input-password">
                            <?php get_svg('lock') ?>
                            <input type="password" id="password" placeholder="請輸入您的密碼 ...">
                            <div class="page-member-register__form-input-password-show">
                                <?php get_svg('eye') ?>
                            </div>
                        </div>
                    </div>
                    <div class="page-member-register__form-input">
                        <label class="-require" for="password_confirm">再次輸入密碼</label>
                        <div class="page-member-register__form-input-password">
                            <?php get_svg('lock') ?>
                    ...
                    <div class="page-member-register__form-checkbox">
                        <input type="checkbox" id="remember">
                        <label for="remember">我同意<a href="">服務條款</a></label>
                    </div>
                    <div class="page-member-register__form-btns">
                        <div class="page-member-register__form-btns-item">
                            <?php 
                                $tag="a";
                                $url="/member/login";
                                $text="返回登入";
                    ...
                    <div class="page-member-register__form-or">
                        <p>OR</p>
                    </div>
                    <h3>以其他方式註冊</h3>
                    <div class="page-member-register__form-social">
                        <div class="page-member-register__form-social-btn -google">
                        ...
                        <div class="page-member-register__form-social-btn -facebook">
                            <?php get_svg('facebook') ?>
                            <p>Facebook 註冊</p>
                        </div>
                        <div class="page-member-register__form-social-btn -line">
                            <?php get_svg('line') ?>
                            <p>LINE 註冊</p>
                        </div>
                    </div>
